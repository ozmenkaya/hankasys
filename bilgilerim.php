<?php 
    ...
    $sth = $conn->prepare('SELECT id, ad, soyad, adres, yetki_id, cep_numarasi, sabit_hat, email, sifre, 
        dogum_tarihi, ise_baslama, aciklama FROM personeller WHERE id=:id AND firma_id = :firma_id');
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="row g-3 needs-validation" action="bilgilerim_db_islem.php" method="POST" id="personel-guncelle-form">
                        ...
                        <div class="row mt-3 mb-2">
                            <div class="col-md-5">
                                <?php 
                                    $sth = $conn->prepare('SELECT id, departman FROM departmanlar WHERE firma_id = :firma_id');
                                    $sth->bindParam('firma_id', $_SESSION['firma_id']);
                                    $sth->execute();
                            ...
                            <div class="col-md-2  d-flex flex-column justify-content-center align-items-center gap-2">
                                <button type='button' id='btnRight' class="btn btn-primary fw-bold btn-sm px-3" >
                                    <i class="fa-solid fa-chevron-right"></i>
                                </button>
                                <button type="button" id='btnLeft' class="btn btn-success fw-bold btn-sm px-3">
                                    <i class="fa-solid fa-chevron-left"></i>
                                </button>
                            </div>
                            <div class="col-md-5">
                                <select class="form-select" multiple="multiple"  name="departman_idler[]" id="lstBox2"  required>
                        ...
                        <div class="row mt-2">
                            <div class="col-md-12">
                                <button class="btn btn-warning" type="submit" name="bilgileri_guncelle" id="personel-guncelle-button">
