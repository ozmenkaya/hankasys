                            ...
                            <?php foreach ($planlanmis_stok_veriler as $index => $planlanmis_stok_veri) { ?>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-12 fw-bold d-flex justify-content-between">
                                        <span class="text-decoration-underline badge bg-secondary p-2">
                                            <i class="fa-sharp fa-solid fa-layer-group"></i>
                                            <?php echo $index +1; ?>-
            ...
            <div class="modal-body">
                <ul class="list-group fw-bold mb-1">
                    ...
                    <li class="list-group-item list-group-item-danger fs-6">
                        <i class="fa-solid fa-circle-exclamation"></i> Aktarılacak Adedi Giriniz!
                    </li>
                </ul>
                <form action="makina_is_ekran_db_islem.php"  method="POST" class="g-3 needs-validation" id="is-aktar-form">
                    <input type="hidden" name="planlama_id" value="<?php echo $planlama_id;?>">
                    <input type="hidden" name="departman_id" value="<?php echo $departman_id;?>">
                    <input type="hidden" name="makina_id" value="<?php echo $makina_id;?>">
                    <input type="hidden" name="uretim_islem_tarih_id" value="<?php echo $uretim_islem_tarih_id;?>">
                    ...
                    <div class="card mb-2 border-secondary border-2">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="form-floating col-md-12">
                                    <input type="number" min="0"  name="aktarilacak_adet" class="form-control" id="aktarilacak_adet"  required>
                                    <label for="aktarilacak_adet" class="form-label">Aktarılacak Adet</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="d-grid">
                        <button type="submit" class="btn btn-success fw-bold" name="aktar" id="is-aktar-button">
                            <i class="fa-regular fa-paper-plane"></i>  GÖNDER
                        </button>
                    </div>
                </form>
...
<script>
    $(function(){
        ...
        $("#isi-aktar-form").submit(function(){
            $("#isi-aktar-button").addClass('disabled');
            return true;
        });
